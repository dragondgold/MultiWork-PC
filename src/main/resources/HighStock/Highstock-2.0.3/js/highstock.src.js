 ...
 *
 * License: www.highstock.com/license
 */
		...
		init: function (pathAnim) {
			...
			$.fn.highcharts = function () {
				...
				if (this[0]) {
					...
					if (options === UNDEFINED) {
						ret = charts[attr(this[0], 'data-highstock-chart')];
					}
				}
...
SVGRenderer.prototype = {
	...
	/**
	 * Create a group
	 * @param {String} name The group will be given a class name of 'highstock-{name}'.
	...
	fontMetrics: function (fontSize, elem) {
		...
		// Applies to the default font family. http://jsfiddle.net/highstock/7xvn7/
...
VMLElement = {
	...
	setSpanRotation: function () {
		...
		// Test case: http://jsfiddle.net/highstock/Ybt44/
...
Axis.prototype = {
	...
	setTickPositions: function (secondPass) {
		...
		if (axis.range && defined(axis.max)) {
			...
			axis.range = null;  // don't use it when running setXAxisExtremes
		}
...
Pointer.prototype = {
	 ...
	 * Run Point.onMouseEnter and display tooltip for the point or points.
	 */
	...
	onDocumentMouseMove: function (e) {
		...
		if (chartPosition && hoverSeries && !this.inClass(e.target, 'highstock-tracker') &&
	...
	onContainerMouseMove: function (e) {
		...
		if ((this.inClass(e.target, 'highstock-tracker') ||
...
Chart.prototype = {
	...
	getContainer: function () {
		var chart = this,
			...
			chartHeight,
			renderTo,
			indexAttrName = 'data-highstock-chart',
			oldChartIndex,
			containerId;
		...
		// because web pages that are saved to disk from the browser, will preserve the data-highstock-chart
	...
	destroy: function () {
		...
		chartCount--;
		chart.renderTo.removeAttribute('data-highstock-chart');
...
defaultPlotOptions.column = merge(defaultSeriesOptions, {
	...
	//pointWidth: null,
	minPointLength: 0,
	cropThreshold: 50, // when there are more points, they will not animate out of the chart on xAxis.setXAxisExtremes
...
extend(Axis.prototype, {
	...
	postProcessTickInterval: function (tickInterval) {
		// TODO: http://jsfiddle.net/highstock/FQm4E/1/
...
Chart.prototype.callbacks.push(function (chart) {
	...
	if (scroller) {
		// redraw the scroller on setXAxisExtremes
